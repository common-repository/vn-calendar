<?php 
/*
A part of VN calendar
*/
date_default_timezone_set('UTC');
$width=$_GET['w'];
$fontsize=$_GET['fs'];
$customstyle=$_GET['cs'];
$timestamp=isset($_GET['ts'])?$_GET['ts']:7*60*60;
...
//var currentLunarYear = getYearInfo(<?php echo date("Y");?>);
var currentDay = <?php echo $time['ngay']; ?>;
var currentMonth = <?php echo $time['thang'];?>;
var currentYear = <?php echo $time['nam'];?>;
var currentLunarDate = getLunarDate(currentDay, <?php echo $time['thang'];?>, <?php echo $time['nam'];?>);
...
function getTodayString() {
	var s = getDayString(currentLunarDate, currentDay , <?php echo $time['thang'];?>, <?php echo $time['nam'];?>);
	s += " n\u0103m " + getYearCanChi(currentLunarDate.year);
	//s=s+" -+- "+getDayName(currentLunarDate);
	//AsTodayString.innerHTML=s;
	return s;
}
	var Std =<?php echo $time['gio'];?>;
	var Min =<?php echo $time['phut'];?>;
	var Sec =<?php echo $time['giay'];?>;
	var asStd =Std;
	var asMin =Min;
	var asSec =Sec;
...
function OutputOptions() {
	this.fontSize = "<?php echo $fontsize;?>pt";
	this.tableWidth = "<?php echo $width;?>px";
}
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	...
	if (solarDate == currentDay && solarMonth == <?php echo $time['thang']; ?> && solarYear == <?php echo $time['nam']; ?>) {
		cellClass = "homnay";
	}
